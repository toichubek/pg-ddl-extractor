 ...
 */
function lineDiff(devPath, prodPath) {
...
function simpleDiff(devLines, prodLines) {
    const changes = [];
...
function formatHtmlReport(summary) {
    ...
    const modifiedByCategory = new Map();
    for (const item of modified) {
