...
exports.getObjectHashes = getObjectHashes;
...
class SnapshotManager {
    ...
    hasChanged(objectKey, currentHash) {
        if (!this.meta)
            return true;
        return this.meta.objectHashes[objectKey] !== currentHash;
    }
    /** Save snapshot metadata */
    save(database, objectHashes) {
 ...
 */
async function getObjectHashes(client) {
    const hashes = {};
    // Tables
